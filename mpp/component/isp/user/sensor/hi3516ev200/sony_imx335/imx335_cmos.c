...
#define IMX335_VMAX_3M_30FPS_12BIT_LINEAR  (0x1194+IMX335_INCREASE_LINES)
...
#define IMX335_RES_IS_3M_12BIT_LINEAR(w, h)    (((w) == 2304) && ((h) == 1296))
...
static HI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    if (IMX335_5M_30FPS_12BIT_LINEAR_MODE == pstSnsState->u8ImgMode) {
        ...
        U32MaxFps = 25;
    } else if (IMX335_3M_30FPS_12BIT_LINEAR_MODE == pstSnsState->u8ImgMode) {
        u32Fll = IMX335_VMAX_3M_30FPS_12BIT_LINEAR;
        U32MaxFps = 30;
    } else {
        u32Fll = IMX335_VMAX_5M_30FPS_12BIT_LINEAR;
        U32MaxFps = 30;
...
static HI_VOID cmos_fps_set(VI_PIPE ViPipe, HI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    switch (pstSnsState->u8ImgMode) {
		...
		case IMX335_3M_30FPS_12BIT_LINEAR_MODE:
            if ((f32Fps <= 30.0) && (f32Fps >= 2.0)) {
                u32MaxFps = 30;
                u32Lines = IMX335_VMAX_3M_30FPS_12BIT_LINEAR * u32MaxFps / DIV_0_TO_1_FLOAT(f32Fps);
                pstSnsState->u32FLStd = u32Lines;
            } else {
                ISP_TRACE(HI_DBG_ERR, "Not support Fps: %f\n", f32Fps);
                return;
...
static HI_VOID cmos_set_pixel_detect(VI_PIPE ViPipe, HI_BOOL bEnable)
{
    ...
    if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		if (IMX335_3M_30FPS_12BIT_LINEAR_MODE == pstSnsState->u8ImgMode) {
            u32FullLines_5Fps = (IMX335_VMAX_3M_30FPS_12BIT_LINEAR * 30) / 5;
        } else {
            return;
        }
    }
...
static HI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
    ...
    if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
        ...
        } else if (IMX335_RES_IS_3M_12BIT_LINEAR(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
            u8SensorImageMode               = IMX335_3M_30FPS_12BIT_LINEAR_MODE;
            g_astimx335State[ViPipe].u32BRL = 1984 * 2;	// what's this?
            pstSnsState->u32FLStd           = IMX335_VMAX_3M_30FPS_12BIT_LINEAR;
        } else {
            IMX335_ERR_MODE_PRINT(pstSensorImageMode, pstSnsState);
            return HI_FAILURE;
        }
...
static HI_VOID sensor_global_init(VI_PIPE ViPipe)
{
    ...
    pstSnsState->bSyncInit = HI_FALSE;
    pstSnsState->u8ImgMode = IMX335_3M_30FPS_12BIT_LINEAR_MODE;
    pstSnsState->enWDRMode = WDR_MODE_NONE;
    pstSnsState->u32FLStd = IMX335_VMAX_3M_30FPS_12BIT_LINEAR;
    pstSnsState->au32FL[0] = IMX335_VMAX_3M_30FPS_12BIT_LINEAR;
    pstSnsState->au32FL[1] = IMX335_VMAX_3M_30FPS_12BIT_LINEAR;
