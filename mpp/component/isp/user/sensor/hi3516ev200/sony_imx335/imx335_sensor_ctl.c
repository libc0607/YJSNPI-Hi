...
#define IMX335_3M_30FPS_12BIT_LINEAR_MODE   (4)   //2304x1296
...
void IMX335_linear_3M30_12bit_init(VI_PIPE ViPipe);
...
void IMX335_init(VI_PIPE ViPipe)
{
    ...
    if (WDR_MODE_2To1_LINE == enWDRMode) {
		...
		if (u8ImgMode == IMX335_3M_30FPS_12BIT_LINEAR_MODE) {
            IMX335_linear_3M30_12bit_init(ViPipe);
        } else if (u8ImgMode == IMX335_5M_30FPS_12BIT_LINEAR_MODE) {
...
void IMX335_linear_3M30_12bit_init(VI_PIPE ViPipe)
{
	...
	// 修改：使用 window cropping mode 裁剪出其中一部分
	// WINMODE=0x4
	IMX335_write_register(ViPipe, 0x3018, 0x04);
	// VMAX 和帧率有关 反正够用 就默认0x1194
	IMX335_write_register(ViPipe, 0x3030, 0x94);
	IMX335_write_register(ViPipe, 0x3031, 0x11);
	IMX335_write_register(ViPipe, 0x3032, 0x00);
	// HMAX 0x226 给的 和帧率有关 就默认
	IMX335_write_register(ViPipe, 0x3034, 0x26);
	IMX335_write_register(ViPipe, 0x3035, 0x02);
	// HTRIMMING_START = 0xCC(204) = 48+13x12 (N=13) 居中
	IMX335_write_register(ViPipe, 0x302C, 0xCC);
	IMX335_write_register(ViPipe, 0x302D, 0x00);
	// HNUM = 0x900(2304) 宽度
	IMX335_write_register(ViPipe, 0x302E, 0x00);
	IMX335_write_register(ViPipe, 0x302F, 0x09);
	// Y_OUT_SIZE=1296=0x510 高度一倍
	IMX335_write_register(ViPipe, 0x3056, 0x10);
	IMX335_write_register(ViPipe, 0x3057, 0x05);
	// AREA3_ST_ADR_1 =0x350 =848=176+672=176+168x4 (M=168) 取个中间值
	IMX335_write_register(ViPipe, 0x3074, 0x50);
	IMX335_write_register(ViPipe, 0x3075, 0x03);
	// AREA3_WIDTH_1 =0xA20=1296*2=2592 高度两倍
	IMX335_write_register(ViPipe, 0x3076, 0x20);
	IMX335_write_register(ViPipe, 0x3077, 0x0A);
	// BLACK_OFFSET_ADR=18=0x12 给的
	IMX335_write_register(ViPipe, 0x30C6, 0x12);
	IMX335_write_register(ViPipe, 0x30C7, 0x00);
	// UNRD_LINE_MAX=100=0x64 给的
	IMX335_write_register(ViPipe, 0x30CE, 0x64);
	IMX335_write_register(ViPipe, 0x30CF, 0x00);
	// UNREAD_ED_ADR=0xE40=3648=848+2592+208
	IMX335_write_register(ViPipe, 0x30D8, 0x40);
	IMX335_write_register(ViPipe, 0x30D9, 0x0E);
	
	
	// ADBIT 0:10/1:12 默认10bit？？不是说好的12bit你看看函数名
    IMX335_write_register(ViPipe, 0x3050, 0x01);
	// INCK SEL 1
    IMX335_write_register(ViPipe, 0x314C, 0xC0);
	// INCK SEL 2 & PLL_IF_GC
    IMX335_write_register(ViPipe, 0x315A, 0x06);
	// INCK SEL 4
    IMX335_write_register(ViPipe, 0x316A, 0x7E);
	// MDBIT 0:10/1:12
    IMX335_write_register(ViPipe, 0x319D, 0x01);
	// SYS_MODE (INCK setting)
    IMX335_write_register(ViPipe, 0x319E, 0x02);
	// XVS_DRV & XHS_DRV
    IMX335_write_register(ViPipe, 0x31A1, 0x00);
	// Fixed values 0x3288~0x3416
    IMX335_write_register(ViPipe, 0x3288, 0x21);
    IMX335_write_register(ViPipe, 0x328A, 0x02);
    IMX335_write_register(ViPipe, 0x3414, 0x05);
    IMX335_write_register(ViPipe, 0x3416, 0x18);
	// ADBIT 10:0x1FF/12:0x047
    IMX335_write_register(ViPipe, 0x341C, 0x47);
    IMX335_write_register(ViPipe, 0x341D, 0x00);
	// Fixed Values 0x3648~0x3796
    IMX335_write_register(ViPipe, 0x3648, 0x01);
    IMX335_write_register(ViPipe, 0x364A, 0x04);
    IMX335_write_register(ViPipe, 0x364C, 0x04);
    IMX335_write_register(ViPipe, 0x3678, 0x01);
    ...
    printf("-------Sony IMX335_init_3M_2304x1296_12bit_linear30 Initial OK!-------\n");
}
