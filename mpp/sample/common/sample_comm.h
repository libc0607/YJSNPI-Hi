...
typedef enum hiSAMPLE_SNS_TYPE_E
{
    ...
    SONY_IMX335_MIPI_3M_30FPS_12BIT,
...
HI_S32 SAMPLE_COMM_VO_StartChn(VO_LAYER VoLayer, VO_DEV VoDev);
HI_S32 SAMPLE_COMM_VO_StopChn(VO_LAYER VoLayer, VO_DEV VoDev);
