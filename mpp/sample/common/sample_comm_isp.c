...
ISP_PUB_ATTR_S ISP_PUB_ATTR_IMX307_MIPI_1M_60FPS =
{
    {0, 0, 1280, 720},
    {1280, 720},
    60,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_IMX335_MIPI_3M_30FPS =
{
    {0, 0, 2304, 1296},
    {2304, 1296},
    30,
...
HI_S32 SAMPLE_COMM_ISP_GetIspAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, ISP_PUB_ATTR_S *pstPubAttr)
{
    switch (enSnsType)
    {
		...
		case SONY_IMX307_2L_MIPI_1M_60FPS_12BIT:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_IMX307_MIPI_1M_60FPS, sizeof(ISP_PUB_ATTR_S));
            break;
        ...
        case SONY_IMX335_MIPI_3M_30FPS_12BIT:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_IMX335_MIPI_3M_30FPS, sizeof(ISP_PUB_ATTR_S));
            break;
