...
combo_dev_attr_t MIPI_4lane_CHN0_SENSOR_IMX335_12BIT_3M_NOWDR_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
VI_DEV_ATTR_S DEV_ATTR_IMX335_3M_BASE =
{
    VI_MODE_MIPI,
    VI_WORK_MODE_1Multiplex,
    {0xFFF00000,    0x0},
...
static VI_PIPE_ATTR_S PIPE_ATTR_2304x1296_RAW12_420_3DNR_RFR =
{
    VI_PIPE_BYPASS_NONE, HI_FALSE, HI_FALSE,
    2304, 1296,
    PIXEL_FORMAT_RGB_BAYER_12BPP,
...
HI_S32 SAMPLE_COMM_VI_GetComboAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, combo_dev_t MipiDev, combo_dev_attr_t *pstComboAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX335_MIPI_3M_30FPS_12BIT:
            hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN0_SENSOR_IMX335_12BIT_3M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S *pstViDevAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX335_MIPI_3M_30FPS_12BIT:
            hi_memcpy(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_IMX335_3M_BASE, sizeof(VI_DEV_ATTR_S));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetPipeAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_PIPE_ATTR_S *pstPipeAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX335_MIPI_3M_30FPS_12BIT:
            hi_memcpy(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_2304x1296_RAW12_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            break;
